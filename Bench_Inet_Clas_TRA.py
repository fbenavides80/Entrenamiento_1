...
# ==============================================================================
class EarlyStopping:
    def __init__(self, patience=5, min_delta=0, path='best_vitb_model.pth'): 
...
# ==============================================================================
# AJUSTE: Aumento el BATCH_SIZE (64 para aprovechar VRAM)
BATCH_SIZE = 64          
EPOCHS = 10              
MODEL_NAME = "ViT-Base-16"
BEST_MODEL_PATH = "best_vitb_transformer.pth"
...
# AJUSTE: Se añade num_workers=4 para carga de datos paralela
...
try:
    ...
    onnx_path = "vitb_despliegue.onnx"
